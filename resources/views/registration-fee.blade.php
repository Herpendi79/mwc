            ...
            <div class="container relative">
                <div class="max-w-4xl mx-auto text-center">
                    <h2 class="xl:text-7xl md:text-5xl leading-snug font-bold tracking-[1px] mb-4" data-sal="zoom-in"
                        data-sal-duration="800" data-sal-delay="200"> Registration Fee</h2>
                    <p class="text-[20px] text-gray-200 max-w-2xl mx-auto" data-sal="slide-right" data-sal-duration="800"
                        data-sal-delay="200">Choose the perfect option that suits your experience. Our flexible
                        pricing plans offer access to inspiring sessions, exclusive networking opportunities, and
                        unforgettable moments throughout the event.</p>
            ...
            <div class="container">
                <div class="max-w-3xl mx-auto text-center mb-15">
                    <p class="mb-2 font-medium uppercase tracking-[1px]" data-sal="zoom-in" data-sal-duration="800"
                        data-sal-delay="100">// Registration Fee</p>
                            ...
                            <thead>
                                <tr class="bg-[#065039] text-white">
                                    <th rowspan="3"
                                        ...
                                        Payment Type</th>
                                    <th colspan="4"
                                        class="p-4 border border-white/20 text-center font-bold uppercase tracking-wider">
                                        Amount</th>
                                    <th rowspan="3"
                                        class="p-4 border border-white/20 text-center align-middle font-bold uppercase tracking-wider">
                                        Deadlines</th>
                                ...
                                <tr class="bg-[#065039] text-white"> {{-- Diubah menjadi text-white --}}
                                    <th colspan="2" class="p-3 border border-white/20 text-center font-semibold">
                                        Indonesia
                                    </th>
                                    <th colspan="2" class="p-3 border border-white/20 text-center font-semibold">
                                        Overseas
                                ...
                                <tr class="bg-[#065039] text-white"> {{-- Diubah menjadi text-white --}}
                                    <th class="p-2 border border-white/20 text-center text-sm uppercase">Offline</th>
                                    <th class="p-2 border border-white/20 text-center text-sm uppercase">Online</th>
                                    <th class="p-2 border border-white/20 text-center text-sm uppercase">Offline</th>
                                    <th class="p-2 border border-white/20 text-center text-sm uppercase">Online</th>
                                </tr>
                            </thead>
                            ...
                            <tbody class="bg-white dark:bg-[#1F1F1F] text-gray-800 dark:text-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                    <td
                                        ...
                                        Presenter</td>
                                    <td class="p-4 border border-gray-200 dark:border-white/10 text-center">IDR 750.000
                                    </td>
                                    <td class="p-4 border border-gray-200 dark:border-white/10 text-center">IDR 450.000
                                    </td>
                                    <td
                                    ...
                                    <td rowspan="3"
                                        ...
                                        <a href="https://www.conference.adaksi.org"
                                            class="text-blue-600 hover:underline font-medium break-all">www.conference.adaksi.org</a>
                                    </td>
                                </tr>
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                    <td
                                        class="p-4 border border-gray-200 dark:border-white/10 font-bold bg-gray-50/50 dark:bg-white/5">
                                        Student Presenter</td>
                                    <td class="p-4 border border-gray-200 dark:border-white/10 text-center">IDR 600.000
                                    </td>
                                    <td class="p-4 border border-gray-200 dark:border-white/10 text-center">IDR 360.000
                                    </td>
                                    <td
                                        class="p-4 border border-gray-200 dark:border-white/10 text-center text-orange-600 font-medium">
                                        $40</td>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                    <td
                                        class="p-4 border border-gray-200 dark:border-white/10 font-bold bg-gray-50/50 dark:bg-white/5">
                                        Participant</td>
                                    <td class="p-4 border border-gray-200 dark:border-white/10 text-center">IDR 200.000
                                    </td>
                                    <td class="p-4 border border-gray-200 dark:border-white/10 text-center">IDR 100.000
                                    </td>
                                    <td
                                        class="p-4 border border-gray-200 dark:border-white/10 text-center text-orange-600 font-medium">
                                        $20</td>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                    ...
                                    <td class="p-4 border border-gray-200 dark:border-white/10 text-center">—</td>
                                    <td class="p-4 border border-gray-200 dark:border-white/10 text-center">—</td>
                                    <td
                                        class="p-4 border border-gray-200 dark:border-white/10 text-center align-middle bg-gray-50/30 dark:bg-white/5">
                                        <a href="https://www.adaksi.org"
                                            class="text-blue-600 hover:underline font-medium break-all">www.adaksi.org</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
