                        ...
                        <div class="blog_left_sidebar">
                            ...
                            <div x-data="{ openModal: false, selectedBahsulId: null }">
                                @foreach ($dataBahsul as $index => $bahsul)
                                    <article class="blog_item mb-5">
                                        <div class="blog_item_img">
                                            ...
                                            <img class="card-img rounded-0"
                                                src="{{ asset('storage/foto_bahsul/' . $currentPhoto) }}"
                                                alt="{{ $bahsul->tema }}"
                                        ...
                                        <div class="blog_details">
                                            ...
                                            <div class="flex flex-wrap items-center justify-between gap-4 mt-4">
                                                ...
                                                <div>
                                                    @if (\Carbon\Carbon::parse($bahsul->tanggal)->endOfDay()->isFuture())
                                                        <button type="button"
                                                            @click="openModal = true; selectedBahsulId = '{{ $bahsul->id_bs }}'"
                                    ...
                                    <div x-show="openModal && selectedBahsulId === '{{ $bahsul->id_bs }}'"
                                        style="display: none;"
                                        ...
                                        <div @click.outside="openModal = false"
                                            ...
                                            <form action="{{ route('bahsul.daftar', $bahsul->id_bs) }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="id_bs" x-model="selectedBahsulId">
                                                ...
                                                <div class="flex flex-col sm:flex-row justify-end gap-2.5 sm:gap-3 w-full">
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget search_widget">
                                <form action="{{ route('bahsul') }}" method="GET">
                            ...
                            <aside class="single_sidebar_widget post_category_widget">
                                ...
                                <ul class="list cat-list">
                                    @foreach ($kategoriList as $k)
                                        <li>
                                            <a href="{{ route('bahsul', ['keyword' => $k->kategori]) }}" class="d-flex">
                                                <p>{{ $k->kategori }}</p>
                                                <p>({{ $k->total }})</p>
                                            </a>
                                        </li>
                            ...
                            <aside class="single_sidebar_widget post_category_widget">
                                ...
                                <ul class="list cat-list">
                                    @foreach ($archives as $arc)
                                        <li>
                                            <a href="{{ route('bahsul', ['bulan' => $arc->month, 'tahun' => $arc->year]) }}"
                                                class="d-flex">
                                ...
                                <div class="relawan-vertical-active">
                                    @foreach ($recentPosts as $index => $post)
                                        <div class="media post_item"
                                            ...
                                            <img src="{{ asset('storage/foto_bahsul/' . $photoToDisplay) }}"
                                                alt="post"
