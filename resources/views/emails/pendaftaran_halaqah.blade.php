...
<body style="font-family: sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 30px auto; border: 1px solid #e0e0e0; border-radius: 12px; overflow: hidden;">
        <div style="background-color: #006633; padding: 25px; text-align: center; color: #ffffff;">
            <h2 style="margin: 0;">Pendaftaran Halaqah Berhasil</h2>
        </div>
        <div style="padding: 30px;">
            <p>Halo, <strong>{{ $name }}</strong>,</p>
            <p>Alhamdulillah, pendaftaran Anda sebagai peserta untuk kegiatan halaqah dengan judul
            ...
            <div style="background-color: #f0f7f4; padding: 15px; border-left: 4px solid #006633; margin: 20px 0;">
                <p style="margin: 0 0 10px 0;"><strong>Jangan Lupa Kegiatan pada:</strong><br>
                    Tanggal: {{ \Carbon\Carbon::parse($tgl)->format('d/m/Y') }}</p>
                <p style="margin: 0;"><strong>Kontak Panitia:</strong><br>
                    {{ $panitia_nama }} ({{ $panitia_telpon }})</p>
            </div>

            <p>Terima kasih atas partisipasi dan keaktifan Anda dalam kegiatan halaqah. Jazakumullah Khairan Katsiran.</p>
        </div>
