        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-8">
                <div class="container mx-auto max-w-6xl h-full flex flex-col">
                    <div class="mb-6">
                        <h2 class="text-3xl font-bold dark:text-white">Tambah Data Opini</h2>
                        <p class="text-gray-500">Buat artikel opini baru.</p>
                    </div>
                    ...
                    <div x-data="{ showAddCategoryModal: false }" class="w-full">
                        ...
                        <div x-show="showAddCategoryModal" x-cloak
                            ...
                            <div @click.away="showAddCategoryModal = false"
                                ...
                                <form action="{{ route('admin.opini.storeKategori') }}" method="POST" class="space-y-4">
                                    @csrf
