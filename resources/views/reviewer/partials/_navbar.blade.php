<header
    ...
    <div class="flex items-center gap-4">
        ...
        <button id="sidebar-open" class="lg:hidden text-2xl dark:text-white transition-transform active:scale-90">
            <i class="ri-menu-2-line"></i>
        </button>
        <h1 class="text-xl font-bold dark:text-white hidden sm:block">Reviewer Dashboard</h1>
    </div>
