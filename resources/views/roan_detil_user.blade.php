                    ...
                    <div class="col-lg-8 posts-list">
                        <div class="single-post">
                            <div class="feature-img">
                                <img class="img-fluid"
                                    src="{{ !empty($dataBerita->poster) && file_exists(public_path('storage/foto_roan/' . $dataBerita->poster))
                                        ? asset('storage/foto_roan/' . $dataBerita->poster)
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            <aside class="single_sidebar_widget search_widget">
                                <form action="{{ route('roan') }}" method="GET">
                                ...
                                <div class="relawan-vertical-active">
                                    @foreach ($recentPosts as $post)
                                        <div class="media post_item">
                                            <img src="{{ !empty($post->poster) && file_exists(public_path('storage/foto_roan/' . $post->poster))
                                                ? asset('storage/foto_roan/' . $post->poster)
                                                : asset('storage/foto_roan/roan-default.jpeg') }}"
