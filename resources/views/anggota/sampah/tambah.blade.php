        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-8">
                <div class="container mx-auto max-w-3xl">
                    <div class="mb-8">
                        <h2 class="text-3xl font-bold dark:text-white">Tambah Donasi Sampah Anda</h2>
                        <p class="text-gray-500">Input detail penyetoran sampah baru Anda.</p>
                    </div>
                    @if ($errors->any())
                    ...
                    <form action="{{ route('anggota.sampah.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                            <div>
                                ...
                                <input type="text" name="penyetor" value="{{ auth()->user()->name }}" readonly
                                    class="w-full p-3 rounded-xl border bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 outline-none cursor-not-allowed">
                            </div>
